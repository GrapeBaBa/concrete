...
//! ```
//!
//! The [`generics`] module contains the actual test functions which use all the aforementioned steps plus:
//! ```ascii
//! ---------------------> Call the tested engine on the actual input entities
//! ```
...
/// + Convert back and forth between prototypical entities and actual entity types used for the tests.
pub struct Maker {
